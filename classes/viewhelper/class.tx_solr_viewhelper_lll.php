...
class tx_solr_viewhelper_Lll implements tx_solr_ViewHelper {
	...
	/**
	 * constructor for class tx_solr_LllViewHelper
	 */
...
if (defined('TYPO3_MODE') && $GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/solr/classes/viewhelper/class.tx_solr_viewhelper_lll.php'])	{
	include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/solr/classes/viewhelper/class.tx_solr_viewhelper_lll.php']);
}
