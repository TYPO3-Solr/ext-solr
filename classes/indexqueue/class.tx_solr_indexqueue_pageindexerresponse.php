...
class tx_solr_indexqueue_PageIndexerResponse {
	...
	public static function getResultsFromJson($jsonEncodedResponse) {
		...
		if (is_array($responseData['actionResults'])) {
			...
			$responseData['actionResults'] = array();
		}
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/solr/classes/indexqueue/class.tx_solr_indexqueue_pageindexerresponse.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/solr/classes/indexqueue/class.tx_solr_indexqueue_pageindexerresponse.php']);
}
