...
class CoreSelectorMenuViewHelper extends AbstractTagBasedViewHelper {
	...
	public function render() {
		$this->tag->addAttribute('onchange', 'jumpToUrl(document.URL + \'&tx_solr_tools_solradministration[action]=setCore&tx_solr_tools_solradministration[core]=\'+this.options[this.selectedIndex].value,this);');
