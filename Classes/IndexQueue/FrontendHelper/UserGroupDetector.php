...
class UserGroupDetector implements FrontendHelper, SingletonInterface
{
    ...
    /**
     * Legacy activation flag
     */
    protected bool $activated = false;

    /**
     * New activation flag (from IndexingInstructions)
     */
    ...
    /**
     * Original TCA backup (for new system)
     */
    protected ?array $originalTca = null;

    /**
     * Collected frontend groups (for new system)
     */
    ...
    {
        if ($this->activated && $this->request instanceof PageIndexerRequest) {
    ...
    public function deactivate(PageIndexerResponse $response): void
    {
        ...
        if ($this->activatedViaInstructions && $this->resultCollector instanceof IndexingResultCollector) {
