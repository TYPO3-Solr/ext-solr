...
class RepositoryTest extends UnitTest
{
    ...
    public function findOneByPageIdAndByLanguageIdReturnsFirstFoundDocument()
    {
        ...
        $apacheSolrDocumentRepository->expects(self::at(0))->method('findByPageIdAndByLanguageId')->willReturn($apacheSolrDocumentCollection);
    ...
    public function findByPageIdAndByLanguageIdReturnsEmptyCollectionIfConnectionToSolrServerCanNotBeEstablished()
    {
        ...
        $apacheSolrDocumentRepository->expects(self::at(0))->method('initializeSearch')->will(self::throwException(new NoSolrConnectionFoundException()));
