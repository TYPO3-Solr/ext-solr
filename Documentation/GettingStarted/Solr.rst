...
.. code-block:: bash
   ...
   cd <EXT:solr 11.6.x>/
   docker build --file Docker/SolrServer/Dockerfile --tag=typo3solr/elts-solr:11.6.x .
...
.. code-block:: bash
    ...
    curl "http://localhost:8983/solr/admin/cores?action=CREATE&name=<core_name>&configSet=ext_solr_11_6_0_elts&schema=german/schema.xml&dataDir=../../data/german"
