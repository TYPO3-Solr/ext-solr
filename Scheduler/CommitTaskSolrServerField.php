...
/**
 * Adds an additional field to specify the Solr server to commit to
 *
 * @author	Georg Kuehnberger <georg@georg.org>
 * @package	TYPO3
 * @subpackage	solr
 */
class Tx_Solr_Scheduler_CommitTaskSolrServerField implements tx_scheduler_AdditionalFieldProvider {
...
if (defined('TYPO3_MODE') && $GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/solr/Scheduler/CommitTaskSolrServerField.php'])	{
	include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/solr/Scheduler/CommitTaskSolrServerField.php']);
}
