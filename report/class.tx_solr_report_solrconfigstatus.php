...
class tx_solr_report_SolrconfigStatus implements tx_reports_StatusProvider {
	 ...
	 * @var	string
	 */
	const RECOMMENDED_SOLRCONFIG_VERSION = 'tx_solr-2-8-0--20120925';
...
if (defined('TYPO3_MODE') && $GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/solr/report/class.tx_solr_report_solrconfigstatus.php'])	{
	include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/solr/report/class.tx_solr_report_solrconfigstatus.php']);
}
