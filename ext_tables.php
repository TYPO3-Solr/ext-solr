...
$boot = function ($extensionKey) {
    if (TYPO3_MODE == 'BE') {
        ...
        \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
            'ApacheSolrForTypo3.' . $extensionKey,
            'searchbackend',
            'Info',
            '',
            [
            ...
            [
                ...
                'labels' => 'LLL:EXT:' . $extensionKey . '/Resources/Private/Language/locallang_mod_info.xlf',
        ...
        \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
            ...
            [
                ...
                'labels' => 'LLL:EXT:' . $extensionKey . '/Resources/Private/Language/locallang_mod_coreoptimize.xlf',
                'navigationComponentId' => 'typo3-pagetree'
            ]
        );
        ...
        \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
            ...
            [
                ...
                'labels' => 'LLL:EXT:' . $extensionKey . '/Resources/Private/Language/locallang_mod_indexqueue.xlf',
                'navigationComponentId' => 'typo3-pagetree'
            ]
        );
        ...
        \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
            ...
            [
                ...
                'labels' => 'LLL:EXT:' . $extensionKey . '/Resources/Private/Language/locallang_mod_indexadmin.xlf',
                'navigationComponentId' => 'typo3-pagetree'
            ]
        );
